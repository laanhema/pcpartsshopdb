...
// ---------------------------------------------------------------------------------
// 2. add constraints (these properties must be unique)
...
// ---------------------------------------------------------------------------------
// 5. add relationships between nodes
// create links between customers and orders + which products each order included
       (c1)-[:ORDERED]->(o1),
       (o1)-[:INCLUDED]->(p1),
       (o1)-[:INCLUDED]->(p5),
       (c2)-[:ORDERED]->(o2),
       ...
       (o10)-[:INCLUDED]->(p8),
// ---------------------------------------------------------------------------------
// create links between customers, reviews and products:
...
// ---------------------------------------------------------------------------------
// create compatibility links between products:
